        ...
        <form className=" px-8 pt-4 pb-8">
          ...
          <div className="pb-2">
            <button
              ...
              className=" w-full text-lg bg-[#332272] text-white font-bold p-4 rounded focus:outline-none focus:shadow-outline"
              type="button"
            >
              Show Statstics
            </button>
          ...
          <div className=" mb-2">
            <button
              ...
              className=" w-full text-lg  bg-[#FF3838] text-white font-bold p-4 rounded focus:outline-none focus:shadow-outline"
              type="button"
            >
              Reset Form
            </button>
