            ...
            {currentRecords.length > 0 ? (
              currentRecords.map((item, index) => (
                <tr
                  key={index}
                  className={`${
                    index % 2 === 0 ? "bg-[#ECECEC]" : "bg-[#F9F9F9]"
                  } text-black border-b rounded-lg text-center font-roboto`}
                >
            ...
            pages.map((page) => (
              <li>
                <button
                  ...
                  className={`${
                    currentPage == page ? "active font-bold text-blue-400" : ""
                  } flex items-center justify-center px-3 h-8 leading-tight  bg-white border border-gray-300 rounded-none hover:bg-gray-100 `}
                >
                  {page}
                </button>
              </li>
